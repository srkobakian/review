...
|Measure |Details| Fig. |
|:--------------------|:------------------------------------------------|:--------------------|
|1. Count| Cancer incidence counts| |
|2. Incidence Rate (per 100,000) | The frequency of cases relative to a fixed population size, usually 100,000 people, within a specific period of time XXX [cite it](https://www.cancerresearchuk.org/health-professional/cancer-statistics/cancer-stats-explained/statistics-terminology-explained#heading-Eleven)|  |
|3. IR (Incidence Ratio)| The incidence rate in a region divided by the average  incidence rate for all of the regions| |
|4. Age-Standardized Rate per 100,000| Standardized by age structure or region|   |
|5. Age-Standardized Relative Risk| Standardized by age structure|  |
|6. SIR (Standardized Incidence Ratio)| The observed number of cases in a region divided by the expected number of cases, if that region had the same age-specific rates as a reference population.  |
|7. Excess Hazard Ratio | The estimate of cancer-related mortality within five years of diagnosis. |  |

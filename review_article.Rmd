...
<!-- this is vague and uninformative 
...
Interactivity and animation add the ability to display more information in the same display, without overloading a single display. It is also a way to invite the viewer to engage with the display.  

XXX Define interactivity, define animation

XXX summarise literature on interactivity with maps, and also animation.

Thinking about interactivity in terms of atlas purpose, it is useful to identify the primary questions that might be asked (or communicated). @CPISACA provide three questions that are generally asked when using a disease map:

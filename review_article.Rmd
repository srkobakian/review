...
Disease maps help to present geographic patterns that may be overlooked in a table, obscuring the geospatially related statistics [@SAMGIS].
By providing a visual representation of cancer statistics, geographic patterns of disease are able to be identified, investigated further and/or effectively addressed.
...
Transforming statistics to visualisations takes advantage of the human visual system, which has been demonstrated to an effective communication channel for a wide range of audiences (insert munzer reference). Visualising cancer statistics enables the non-expert audience to access the outputs of complicated spatial epidemeological analyses. These visualisation show individual observations, or observation points, aggregated into communities and geographical units.
Visualising diseases on maps is often the first step in exploratory spatial data analysis and effectively helps in the formulation of hypotheses [@MTMSIH]. 
...
plot1 <- png::readPNG('cancer_map_images/choropleths/21.choropleth2.png')
plot2 <- png::readPNG('cancer_map_images/choropleths/29.choropleth.png')
plot3 <- png::readPNG('cancer_map_images/choropleths/30.choropleth.png')
plot4 <- png::readPNG('cancer_map_images/choropleths/1.png')
plot5 <- png::readPNG('cancer_map_images/choropleths.2/6.choropleth.png')
plot6 <- png::readPNG('cancer_map_images/choropleths/27.choropleth.png')
...
plot9 <- png::readPNG('cancer_map_images/choropleths.2/7.choropleth.png')
plot10 <- png::readPNG('cancer_map_images/choropleths/23.choropleth.png')
plot11 <- png::readPNG('cancer_map_images/choropleths.2/24.choropleth.png')
...
plot14 <- png::readPNG('cancer_map_images/choropleths/15.choropleth.png')
plot15 <- png::readPNG('cancer_map_images/choropleths/25.choropleth.png')
...
```{r choropleth-grid-print, echo = FALSE, out.width= '100%', fig.cap = "Insert grid title and references to individual tiles (ref)"}

...
```{r choropleth-grid-create, message=FALSE, fig.cap = "Publicly available choropleth cancer maps, published between 2010 and 2015. Sourced from: @roberts2019communication"}
library(cowplot)

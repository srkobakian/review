...
Web atlases have employed interactivity to expand the communicative ability of an atlas.
It is useful to identify the primary questions that might be asked by atlases users, and allow the display to change to best answer these questions.
...
This is especially true when some areas are small and difficult to identify in a display.
...
Dynamic visual interfaces allow users to interaction with spatial information, they respond when users interrogate them for information [@MCRG].
...
Interaction allows for the focus of the display to change in spatial scale, or location, through zooming and panning functionality.

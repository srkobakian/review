...
```{r choropleth-grid-create, message=FALSE, fig.cap = "Public facing choropleth cancer maps. [Globocan 2012: Estimated  Cancer Incidence, Mortality and Prevalence](http://globocan.iarc.fr/Pages/Map.aspx), "}
library(grid)
library(png)
library(gridExtra)

...
<!--
Current atlases utilising choropleth methods include Australia: 
...
Keep neighbours by keeping borders intact.

From a computer graphics perspective it is a problem of 'map deformation' to account for the value assigned to each area. @ACA discuss their implementation of three methods for creating value - by - area cartograms. Defining cells, and manipulating the display according to statistical value of the cell. 
@ECGC present the problem of maintaining shape presevation in non-contiguous cartograms.
 
 
eg. state by population
Highlight the value of animating contigous to see changes over time, US can be recognisable but animation aides interpretation 
...
This helps to draw attention to large value areas, relies on reader being able to see all areas on a map, and know the difference between initial geography and new layout given by a cartogram.

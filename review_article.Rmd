...
In situations where the population and their health is of interest, not the land they live on, it is reasonable to explore views that enhance the communication of the cancer statistics.
...
Cancer statistics directly represent and relate to the populations living within individual geographical areas.
...
Just as geographers are no longer the only creators of maps, @CPISACA suggests the audiences of spatial health data analysis have extended beyond researchers to the public, policymakers and the media. Now many examples of choropleth maps can be found on the websites of government, media, health and other public facing organisations (insert ref for Jessie's grey lit review).
...
The familiarity of the geography is a worthy consideration when presenting results of spatial analysis. Just as geographers are no longer the only creators of maps, @CPISACA suggests the audiences of spatial health data analysis have extended beyond researchers to the public, policymakers and the media. __(repeated sentence)__
While the areas are recognisable shapes, they are often politically driven boundaries with individual areas being of both non-uniform size, and population densities. In addition these boundaries are often subject to change over time. 
The different population and geographical sizes of administrative areas can unduly attract focus to the shades of the unpopulated but large areas [@EI]. 
...
Choropleths consider the spatial structures and present information regarding the individuals, their communities and organization into larger units @SAMGIS.
...
Almost 100 years of cancer mapping in the United States and the United Kingdom has seen increased effectiveness in the presentation of cancer statistics.
...
Howe [-@HEDP] describes Stock's development of the standardised mortality ratios through the 1930s. Table \ref{measures} summarises the measures presented in published cancer atlases, and provides a definition of each measure.
...
```{r choropleth-grid-print, echo = FALSE}

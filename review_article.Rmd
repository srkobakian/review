...
locally so that the shapes of very small areas on a traditional map and a cartogram would be similar.
...
Original value by area cartograms, especially the tile method, laid the foundation for the modern alternative displays.

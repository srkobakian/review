...
A contiguous cartogram allows the map space to highlight the distribution of the variable. These displays keep spatial relationships of neighbours intact by preserving borders when adjusting sizes [@NAC].
...
A continuous area cartogram maintains connectivity of the map regions while areas are resized according to a statistic [@CBATCC].

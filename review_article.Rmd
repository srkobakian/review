...
```{r ggtilemap, fig.cap = "A tile map and geofaceted map of the Unites States of America. Each state in the tile map has been colored according to the average age-adjusted rate of incidence for lung and bronchus for females and males in the United States 2012-2016. Each state has been represented by a square, each square is the same size. The geofaceted map allows the rates for males and females to be contrasted. It has the same layout as the tile map, but shows more information per state than ", message=FALSE, warning=FALSE, fig.width=12, fig.height=6, out.width = "100%"}

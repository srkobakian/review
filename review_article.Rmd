...
The paper is organised as follows.  The next section describes the choropleth map which is the common approach to disease maps. Section XXX surveys atlases in use today. Section XXX describes an alternative display, the cartogram what may be useful for countries that have heterogeneously sized geographic units. The pros and cons of these approaches is discussed in Section XXX. Interactivity options are described in Section XXX, and the paper finishes with a discussion. 
...
ggdraw() +
  ...
  draw_plot_label(c("a", "b", "c", "d", "e", "f", "g"), 
    c(0.015, 0.33, 0.63, 0.015, 0.33, 0.015, 0.63), 

...
The paper is organised as follows.  The next section describes the choropleth map which is the common approach to disease maps. Section XXX surveys atlases in use today. Section XXX describes an alternative display, the cartogram what may be useful for countries that have heterogeneously sized geographic units. The pros and cons of these approaches is discussed in Section  XXX. Disease maps are more useful when made interactive, and common options are described in Section  XXX, along with a discussion of benefits and disadvantages. The last section summarises the paper and discusses future directions. 

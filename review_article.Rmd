...
Howe [-@HEDP] describes Stock's development of the standardised mortality ratios through the 1930s. Table \ref{measures} presents summarises the measures presented in published cancer atlases, and provides a definition of each measure.

Table: \label{measures} Measures used to report cancer statistics
...
ggsave(filename = "figures/choropleth_grid.png", plot = choropleth_grid, device = "png", width = 12, height = 6, dpi = 300)
```

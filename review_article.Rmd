...
The cancer atlases covered geographies from all around the world, most focused on single nations.
Figure \@ref(choropleth-grid-create) displays a global (b), national (a,d,e,f) and state (c,g) choropleths. 

...
@SE reports the increase in disease mapping development due to the availability of geographic information system softwares. 
...
Cartograms are a thematic map, presenting statistical and geographical information like choropleths. @ACTUC suggests the difference is the intentional and desirable augmentation of the size, shape or distance of geographical areas. World projections reflect the frequent distortions seen from altering perspectives. Choropleth maps will always be distorted if they cover enough of the globe, as will photographs of the globe from space. Cartogram creation requires choosing a favourable distortion of the geography for presenting the set of spatial information.
This concept was originally implemented to allow a map base that represented the proportion of the population within each region. @ACTUC considers this design a 'more socially just form of mapping' by giving all members of the population 'equitable representation'. This is known as an iso-demographic map, and the design inherently lends itself to epidemiolgy. 
@HEDP argues that 'cancer occurs in people, not in geographical areas' and the map base should reflect this to avoid allocating 'undue prominence' to rural areas. @DMAHP reduce the visual impact of large areas with small populations, the distortion of spatial areas is proportional to the denominator variable. 

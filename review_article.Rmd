...
|d. Hexagon Tessellation| Each state is represented by a hexagon of equal size. The neighboring states are easily contrasted, however the north east regions has been displaced from their geographic location. The sparsity of the population in the Mid West is highlight by the light yellow color, the age adjusted rate in Kentucky is the darkest and its neighbors are similar.|
...
Daniel Dorling presented an alternative display engineers to highlight the spatial distribution and neighborhood relationships without complex distortions of borders and boundaries. This approach opposes preserving the intricate shape details and is founded in the simple question put forward by Daniel Dorling -@ACTUC:
...
Some mix of tiling, faceting or even micromaps, which allow some spatial continuity while also zooming into small areas, are good solutions for difficult geographies. Table \ref{tab:methods} summarizes key criteria for evaluating map and alternative displays. Suggestions and comments to help map creators best communicate their health data and spatial analyses a re provided in @CPISACA and @SAMGIS.

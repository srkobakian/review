...
In epidemiology, choropleths are often used as a mapping tool in the study of the spatial distribution. Almost 100 years of cancer maps have explored the US and the UK with increased effectiveness in presentation of unbiased rates. 
The data collection methods, and administrative control within regions lends itself choropleth visualisation, for the presentation of cancer mortality rates across regions. Mortality and incidence rates are now presented age adjusted, and as relative rates of risk across the population.

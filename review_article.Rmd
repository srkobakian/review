...
The paper is organised as follows.  The next section, [Map displays for disease data](#choropleths), describes the choropleth map which is the common approach to disease maps. Section [Publicly available atlases](#public) surveys atlases in use today. The [Alternative displays](#alternative) describes an alternative display, the cartogram what may be useful for countries that have heterogeneously sized geographic units. The pros and cons of these approaches is discussed in Section [Comparison of mapping methods](#compare). Disease maps are more useful when made interactive, and common options are described in Section [Animation and Interactivity](#interacting), along with a discussion of benefits and disadvantages. The last section summarises the paper and discusses future directions. 
...
# Alternative displays {#alternative}
...
# Comparison of mapping methods (#compare)

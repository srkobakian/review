...
These true maps rely on visual perception, a fallible metric as it can cause viewers to 'weight the shades from the largest areas more heavily.' The inferences derived from visual inspection, and the hypotheses developed can suffer from 'bias'. The use of thematic disease mapping was motivated by a 'desire to evaluate geographical patterns' @DMAHP. This technique has been seen as a 'trigger for questions' which drives research of spatial distributions of diseases. @MACM also recognise the intuition that can be derived from choropleths with the critique that they must be 'validated by rigorous statistical analyses.' 
...
The authors recognise that the creation of cartograms was largely the work of professional cartographers until the innovation of geographical information systems that welcomed 
map users as map creators. These systems are utilised depending on 'the effectiveness, efficiency, and satisfaction of the map products (Nielsen 1994)'.
...
Cartograms are a thematic map, presenting statistical and geographical information like choropleths. @AC suggests the difference is the intentional and desirable augmentation of the size, shape or distance of geographical areas.
This was originally implemented to allow a map base that represented the proportion of the population within each region. @AC considers this design a 'more socially just form of mapping' by giving all members of the population 'equitable representation'. This is known as an iso-demographic map, and the design inherently lends itself to epidemiolgy. @HEDP argues that 'cancer occurs in people, not in geographical areas' and the map base should reflect this to avoid allocating 'undue prominence' to rural areas. @DMAHP reduce the visual impact of large areas with small populations. The distortion of spatial areas is proportional to the denominator variable. 


Alternatively, the area on the map space can represent the value. There have been many algorithms presented, @SAIC investigate these implementations and the "statistical accuracy, geographical accuracy, and topological accuracy".
...
Cartograms keep spatial relationships of neighbours intact by preserving borders when adjusting sizes.
...
Requires knowledge of the methods

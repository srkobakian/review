...
```{r choropleth-grid-create, message=FALSE, warning = FALSE, fig.cap = "A selection of choropleth cancer maps available online.", out.width='100%', fig.align='center', fig.width=12, fig.height=10}
library(cowplot)
